...
int musica[] =
{
  NOTA_C4, NOTA_C4,          //NOTA DÓ DA QUARTA ETAPA
  NOTA_D4, NOTA_C4, NOTA_F4, //NOTA RÉ NA QUARTA ETAPA, NOTA DÓ DA QUARTA ETAPA, NOTA FÁ DA QUARTA ETAPA
...
void loop()
{
  for (int nota = 0; nota < (sizeof(musica) / sizeof(int)); nota++)
  {
    ...
    delay(duracaoNota * 1.3); //Duração da nota
    noTone(som);
  }
  delay(5000);
}
